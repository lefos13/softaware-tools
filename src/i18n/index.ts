...
const messages = {
  en: {
    ...
    accessDashboard: {
      ...
      usageMixTitle: "Requests/Words usage mix",
    ...
    adminTokens: {
      ...
      requestResult: {
        ariaLabel: "Request email status",
        kicker: "Email delivery",
        approvedTitle: "Approval email sent",
        approvedDescription:
          'The approval email with access details was sent to {email} for "{alias}".',
        rejectedTitle: "Rejection email sent",
        rejectedDescription: 'The rejection email was sent to {email} for "{alias}".',
      },
      accessTokens: "Access Tokens",
      total: "Total",
      filteredSummary: "Showing {filtered} of {total} tokens.",
      searchPlaceholder: "Search by alias or token id",
      noAccessTokens: "No access tokens found.",
      noFilteredTokens: "No tokens match the current filters.",
      type: "Type",
      id: "id",
      expires: "Expires",
      ...
      detailsAction: "View limits details",
      edit: "Edit",
      revoke: "Revoke",
      renew: "Renew",
      extend: "Extend",
      detailsTitle: "Token limits details",
      detailsDescription: 'Service policies and usage breakdown for "{label}".',
      filters: {
        allStatuses: "All statuses",
        allTypes: "All types",
      },
      sortOptions: {
        ...
        createdAtAsc: "Oldest created",
        aliasAsc: "Alias A-Z",
        aliasDesc: "Alias Z-A",
        expiresAsc: "Expires sooner",
        expiresDesc: "Expires later",
      ...
      errors: {
        ...
        copyTokenId: "Could not copy token id.",
    ...
    pages: {
      ...
      plans: {
        title: "Access plans",
        subtitle:
          "Compare included usage, review service presets, and send one request for the access your team needs.",
      },
      pdfServices: {
        title: "PDF Services",
    ...
    plans: {
      ...
      alias: "Alias",
      aliasPlaceholder: "Example: Editorial team",
      email: "Email",
      ...
      hero: {
        ...
        subtitle:
          "See the live service limits, compare the options, and request access from one page.",
        lead: "Use the free path for lighter work, or request broader limits when your team needs more room.",
        cta: "Request access",
        microcopy: "Simple limits. Clear next step.",
        panelLabel: "Quick view",
        panelTitle: "Live catalog, simple request",
        panelSubtitle: "Choose what you need and send one request.",
        points: {
          guidance: "Compare included access with expanded presets.",
          catalog: "Limits come from the current catalog.",
          delivery: "Approved access is sent by email.",
        },
      },
      comparison: {
        ...
        freeBody: "Best for occasional use, trials, and smaller day-to-day tasks in the browser.",
        paidHeading: "Request broader service coverage",
        paidBody:
          "Best when you need higher request or word limits, multiple services, or a preset chosen for your workflow.",
        notIncluded: "Not included in the free path",
        columns: {
          service: "Service",
          free: "Free",
      ...
      spotlight: {
        ...
        free: {
          ...
          features: {
            access: "Included access for lighter work",
            limits: "Current limits from the live catalog",
            start: "Good for trials and occasional use",
            browser: "Works directly in the browser",
        ...
        premium: {
          ...
          features: {
            ...
            email: "Approved access is sent by email",
            multiService: "Request multiple services together",
            review: "Reviewed by the support team",
          },
        },
      },
      catalog: {
        title: "Service plan catalog",
      ...
      form: {
        ...
        subtitle: "Add your details and select only the services you need.",
        sideLabel: "Keep it simple",
        sideTitle: "Short requests move faster",
        sideBody: "Add a clear name, one email, and only the services you expect to use.",
        ...
        points: {
          identity: "Add a clear name and the email that should receive the reply.",
          selection: "Choose one preset only for the services you need.",
          review: "The support team reviews the request and replies by email.",
        },
      },
      trust: {
        title: "A concise process you can trust",
        subtitle: "A few practical assurances without turning the page into legal copy.",
        items: {
          privacy: {
            title: "Request details stay focused",
            body: "Only the information needed to review and deliver access is requested here.",
          },
          review: {
            title: "Human review before approval",
            body: "Requests are checked by the support team before any access token is sent out.",
          },
          access: {
            title: "Catalog-led access choices",
            body: "The options shown on this page come from the live backend catalog, not hardcoded marketing claims.",
          },
        },
      },
      status: {
      ...
      errors: {
        ...
        submit: "Could not submit the access request.",
      },
      /*
        Validation messages align with the plans form constraints so users get
        immediate, local feedback before the request call is attempted.
      */
      validation: {
        aliasRequired: "Alias is required.",
        aliasMin: "Alias must be at least {min} characters.",
        aliasMax: "Alias cannot be longer than {max} characters.",
        emailRequired: "Email is required.",
        emailInvalid: "Enter a valid email address.",
        servicesRequired: "Select at least one service preset.",
        servicesInvalid: "One or more selected service presets are not valid.",
      },
      policyKinds: {
        unlimited: "Unlimited",
      ...
      serviceLabels: {
        ...
        pdfExtractText: "PDF Text Export",
        pdfEditPages: "PDF Page Editing",
        pdfPageNumbers: "PDF Page Numbers",
        pdfWatermark: "PDF Watermarking",
        pdfFromImages: "Images to PDF",
        imageConvert: "Image Conversion",
        imageCompression: "Image Compression",
        booksGreekEditor: "Greek Book Editing",
      },
      presetLabels: {
        common: {
          free: "Included",
  ...
  el: {
    ...
    accessDashboard: {
      ...
      usageMixTitle: "Μείγμα χρήσης αιτημάτων/λέξεων",
    ...
    adminTokens: {
      ...
      requestResult: {
        ariaLabel: "Κατάσταση αποστολής email",
        kicker: "Αποστολή email",
        approvedTitle: "Στάλθηκε email έγκρισης",
        approvedDescription:
          'Το email έγκρισης με τα στοιχεία πρόσβασης στάλθηκε στο {email} για το "{alias}".',
        rejectedTitle: "Στάλθηκε email απόρριψης",
        rejectedDescription: 'Το email απόρριψης στάλθηκε στο {email} για το "{alias}".',
      },
      accessTokens: "Access tokens",
      total: "Σύνολο",
      filteredSummary: "Προβολή {filtered} από {total} tokens.",
      searchPlaceholder: "Αναζήτηση με alias ή token id",
      noAccessTokens: "Δεν βρέθηκαν access tokens.",
      noFilteredTokens: "Δεν υπάρχουν tokens για τα τρέχοντα φίλτρα.",
      type: "Τύπος",
      id: "id",
      expires: "Λήγει",
      ...
      detailsAction: "Προβολή λεπτομερειών ορίων",
      edit: "Επεξεργασία",
      revoke: "Ανάκληση",
      renew: "Ανανέωση",
      extend: "Επέκταση",
      detailsTitle: "Λεπτομέρειες ορίων token",
      detailsDescription: 'Πολιτικές υπηρεσιών και ανάλυση χρήσης για "{label}".',
      filters: {
        allStatuses: "Όλες οι καταστάσεις",
        allTypes: "Όλοι οι τύποι",
      },
      sortOptions: {
        createdAtDesc: "Νεότερα πρώτα",
        createdAtAsc: "Παλαιότερα πρώτα",
        aliasAsc: "Alias Α-Ω",
        aliasDesc: "Alias Ω-Α",
        expiresAsc: "Λήξη νωρίτερα",
        expiresDesc: "Λήξη αργότερα",
        statusAsc: "Κατάσταση Α-Ω",
        statusDesc: "Κατάσταση Ω-Α",
      },
      columns: {
        alias: "Alias",
        type: "Τύπος",
      ...
      pagination: {
        ...
        next: ">",
        last: ">>",
        pagesAria: "Σελίδες πίνακα token",
      },
      usage: {
      ...
      success: {
        ...
        copiedId: "Το token id αντιγράφηκε.",
      ...
      errors: {
        ...
        copyTokenId: "Δεν ήταν δυνατή η αντιγραφή του token id.",
    ...
    pages: {
      ...
      plans: {
        title: "Πλάνα πρόσβασης",
        subtitle:
          "Συγκρίνετε την ενσωματωμένη χρήση, δείτε τα presets ανά υπηρεσία και στείλτε ένα αίτημα για την πρόσβαση που χρειάζεται η ομάδα σας.",
      },
      pdfServices: {
        title: "Υπηρεσίες PDF",
        subtitle:
    ...
    plans: {
      ...
      requestSubtitle:
        "Στείλτε ποιος χρειάζεται πρόσβαση και ποια presets υπηρεσιών πρέπει να εξεταστούν. Η ομάδα υποστήριξης απαντά με email.",
      defaultTtl: "Προεπιλεγμένο TTL εγκεκριμένου token: {ttl}",
      alias: "Alias",
      aliasPlaceholder: "Παράδειγμα: Συντακτική ομάδα",
      email: "Email",
      emailPlaceholder: "name@example.com",
      ...
      hero: {
        ...
        subtitle: "Δείτε τα τρέχοντα όρια, συγκρίνετε επιλογές και στείλτε αίτημα από μία σελίδα.",
        lead: "Μείνετε στη δωρεάν διαδρομή για ελαφρύτερη χρήση ή ζητήστε μεγαλύτερα όρια όταν η ομάδα σας χρειάζεται περισσότερο χώρο.",
        cta: "Αίτημα πρόσβασης",
        microcopy: "Απλά όρια. Καθαρό επόμενο βήμα.",
        panelLabel: "Γρήγορη εικόνα",
        panelTitle: "Ζωντανός κατάλογος, απλό αίτημα",
        panelSubtitle: "Διαλέξτε τι χρειάζεστε και στείλτε ένα αίτημα.",
        points: {
          guidance: "Συγκρίνετε τη διαθέσιμη πρόσβαση με τα presets.",
          catalog: "Τα όρια έρχονται από τον τρέχοντα κατάλογο.",
          delivery: "Η εγκεκριμένη πρόσβαση στέλνεται με email.",
        },
      },
      comparison: {
        title: "Δωρεάν ή πρόσβαση με token",
        subtitle:
          "Χρησιμοποιήστε τη δωρεάν διαδρομή για πιο ελαφριά εργασία ή ζητήστε ευρύτερα όρια για παραγωγική χρήση.",
        freeHeading: "Ξεκινήστε γρήγορα με την ενσωματωμένη πρόσβαση",
        freeBody:
          "Ταιριάζει σε περιστασιακή χρήση, δοκιμές και μικρότερες καθημερινές εργασίες στον browser.",
        paidHeading: "Ζητήστε μεγαλύτερη κάλυψη υπηρεσιών",
        paidBody:
          "Ταιριάζει όταν χρειάζεστε περισσότερα αιτήματα ή λέξεις, πολλές υπηρεσίες ή preset πιο κοντά στη ροή εργασίας σας.",
        notIncluded: "Δεν περιλαμβάνεται στη δωρεάν διαδρομή",
        columns: {
          service: "Υπηρεσία",
          free: "Δωρεάν",
      ...
      spotlight: {
        ...
        free: {
          ...
          features: {
            access: "Περιλαμβανόμενη πρόσβαση για πιο ελαφριά χρήση",
            limits: "Τρέχοντα όρια από τον ζωντανό κατάλογο",
            start: "Καλή επιλογή για δοκιμές και περιστασιακή χρήση",
            browser: "Λειτουργεί απευθείας στον browser",
        ...
        premium: {
          ...
          features: {
            ...
            email: "Η εγκεκριμένη πρόσβαση στέλνεται με email",
            multiService: "Αίτημα για πολλές υπηρεσίες μαζί",
            review: "Έλεγχος από την ομάδα υποστήριξης",
          },
        },
      },
      catalog: {
        title: "Κατάλογος πλάνων υπηρεσιών",
      ...
      form: {
        title: "Αίτημα πρόσβασης",
        subtitle: "Συμπληρώστε τα στοιχεία σας και επιλέξτε μόνο τις υπηρεσίες που χρειάζεστε.",
        sideLabel: "Κρατήστε το απλό",
        sideTitle: "Τα σύντομα αιτήματα κινούνται πιο γρήγορα",
        sideBody:
          "Βάλτε ένα καθαρό όνομα, ένα email και μόνο τις υπηρεσίες που περιμένετε να χρησιμοποιήσετε.",
        ...
        points: {
          identity: "Συμπληρώστε ένα καθαρό όνομα και το email που θα λάβει την απάντηση.",
          selection: "Διαλέξτε ένα preset μόνο για τις υπηρεσίες που χρειάζεστε.",
          review: "Η ομάδα υποστήριξης εξετάζει το αίτημα και απαντά με email.",
        },
      },
      trust: {
        title: "Μια σύντομη διαδικασία που εμπνέει εμπιστοσύνη",
        subtitle: "Λίγες πρακτικές διαβεβαιώσεις χωρίς περιττό νομικό κείμενο.",
        items: {
          privacy: {
            title: "Τα στοιχεία του αιτήματος μένουν στοχευμένα",
            body: "Ζητούνται μόνο οι πληροφορίες που χρειάζονται για έλεγχο και αποστολή πρόσβασης.",
          },
          review: {
            title: "Ανθρώπινος έλεγχος πριν από την έγκριση",
            body: "Τα αιτήματα εξετάζονται από την ομάδα υποστήριξης πριν σταλεί οποιοδήποτε token πρόσβασης.",
          },
          access: {
            title: "Επιλογές βασισμένες στον κατάλογο",
            body: "Οι επιλογές της σελίδας έρχονται από τον ζωντανό κατάλογο του backend και όχι από στατικό marketing copy.",
          },
        },
      },
      status: {
        error: "Υπάρχει πρόβλημα",
        success: "Το αίτημα παραλήφθηκε",
        loading: "Φόρτωση καταλόγου",
        idle: "Κατάσταση",
      },
      errors: {
        load: "Δεν ήταν δυνατή η φόρτωση του καταλόγου πλάνων.",
        submit: "Δεν ήταν δυνατή η υποβολή του αιτήματος πρόσβασης.",
      },
      /*
        Τα μηνύματα ελέγχου ταιριάζουν με τους κανόνες της φόρμας ώστε ο
        χρήστης να διορθώνει το αίτημα πριν σταλεί στο backend.
      */
      validation: {
        aliasRequired: "Το alias είναι υποχρεωτικό.",
        aliasMin: "Το alias πρέπει να έχει τουλάχιστον {min} χαρακτήρες.",
        aliasMax: "Το alias δεν μπορεί να ξεπερνά τους {max} χαρακτήρες.",
        emailRequired: "Το email είναι υποχρεωτικό.",
        emailInvalid: "Συμπληρώστε έγκυρη διεύθυνση email.",
        servicesRequired: "Επιλέξτε τουλάχιστον ένα preset υπηρεσίας.",
        servicesInvalid: "Μία ή περισσότερες επιλογές preset δεν είναι έγκυρες.",
      },
      policyKinds: {
        unlimited: "Απεριόριστο",
      ...
      serviceLabels: {
        ...
        pdfExtractText: "Εξαγωγή κειμένου PDF",
        pdfEditPages: "Επεξεργασία σελίδων PDF",
        pdfPageNumbers: "Αρίθμηση σελίδων PDF",
        pdfWatermark: "Υδατογράφημα PDF",
        pdfFromImages: "Εικόνες σε PDF",
        imageConvert: "Μετατροπή εικόνων",
        imageCompression: "Συμπίεση εικόνων",
        booksGreekEditor: "Επιμέλεια ελληνικών βιβλίων",
      },
      presetLabels: {
        common: {
          free: "Περιλαμβάνεται",
