...
import type { JsonToolOptions, JsonToolRunRequest } from "../../types/jsonTools";
...
interface ToolInputFactoryResult {
  input: string;
  secondaryInput?: string;
  options?: JsonToolOptions;
}

const inputByTool: Record<string, () => ToolInputFactoryResult> = {
...
const isVisualTool = (toolId: string): boolean =>
  toolId === "json-to-image" || toolId === "screenshot-json";
